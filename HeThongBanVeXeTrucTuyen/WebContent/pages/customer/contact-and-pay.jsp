	...
	<div class="wrapper" id="wrapper">
		...
		<div class="tien-trinh">
		 <ul class="progress-indicator">
            ...
            <li class="completed">
                <span class="bubble"></span>
                Chọn chuyến <i class="uk-icon-check-circle"></i><br><small></small>
            </li>
            <li class="completed">
                <span class="bubble"></span>
                Chọn chỗ  <i class="uk-icon-check-circle"></i><br><small></small>
            </li>
            <li class="active">
                <span class="bubble"></span>
               Điền thông tin  <i class="uk-icon-cogs"></i>
            </li>
            <li>
                <span class="bubble"></span>
...
-->
<form  name="formInfo" action="<%=request.getContextPath() %>/BusController?type=<%=Variables.INFO%>" method="post"
											class="uk-form uk-form-horizontal book-ticket-form">
										...
										<div class="uk-text-muted uk-margin uk-visible-large">
											...
											<div class="uk-form-row">
												<label class="uk-form-label width-150" for="#userPhone"
													...
													class="uk-text-danger">(*):</span></label>
												<input type="text" id="txtSdt" name="txtSdt">
											</div>
											<div class="uk-form-row">
												<label class="uk-form-label" for="#userNote">Ghi
													chú:</label>
												<div class="uk-form-controls">
													<textarea rows="4" class="uk-width-1-1" id="txtGhiChu" name="txtGhiChu"></textarea>
												</div>
											</div>
											<br>
											<!-- <a
									...
									<div class="inner">
										<div data-uk-accordion="{showfirst:false}"
														...
														<div id="pm_12" class="">
															<label> <input type="radio" name="rdpayment"
																id="rdpayment_12" value="12"> <span><img
																	src="http://media.hlink.vn/u/bus/payment/2015/08/29/05/42//100_48/onepay.jpg"></span>
															</label>
														</div>
														<div id="pm_18" class="">
															<label> <input type="radio" name="rdpayment"
																id="rdpayment_18" value="18"> <span><img
																	src="http://media.hlink.vn/u/bus/payment/2015/08/29/08/13//100_48/banknetvn.jpeg"></span>
															</label>
														</div>
														<div id="pm_20">
															<label> <input type="radio" name="rdpayment"
																id="rdpayment_20" value="20"> <span><img
																	src="http://media.hlink.vn/u/bus/payment/2015/08/29/08/12//100_48/senpay.gif"></span>
															</label>
														</div>
													</div>
														...
														<li id="pm_bank_12" class="">
															...
															<div class="showbankfix">
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/22//80_24/bank_abb.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/24//80_24/bank_bacabank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/18//80_24/bank_bidv.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/18//80_24/bank_donga.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/21//80_24/bank_exim.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/26//80_24/bank_hdbank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/19//80_24/bank_maritimebank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/18//80_24/bank_mbbank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/22//80_24/bank_namabank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/25//80_24/bank_ocebank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/20//80_24/bank_sacombank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/31//80_24/scb.png) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/29/04/41//80_24/bank_sea.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/17//80_24/bank_techcombank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/25//80_24/bank_tienphong.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/26//80_24/bank_vib.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/25//80_24/bank_vietabank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/21//80_24/b-logo-vcb.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/19//80_24/bank_vpbank.jpg) no-repeat center center"></div>
														...
														<li id="pm_bank_18" class="">
															...
															<div class="showbankfix">
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/22//80_24/bank_abb.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/22/38//80_24/bank_agribank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/23//80_24/bank_gpbank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/22//80_24/bank_namabank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/20//80_24/bank_pgbank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/20//80_24/bank_sacombank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/23//80_24/bank_saigonbank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/17//80_24/bank_vcb.jpg) no-repeat center center"></div>
														...
														<li id="pm_bank_20">
															...
															<div class="showbankfix">
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/22//80_24/bank_abb.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/17//80_24/bank_acb.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/22/38//80_24/bank_agribank.jpg) no-repeat center center"></div>
																<div class="showbankimg"
																	style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/21//80_24/bank_exim.jpg) no-repeat center center"></div>
											...
											<div data-wrapper="true"
												...
												<div class="uk-accordion-content">
													<label> <input type="radio" name="rdpayment"
														id="rdpayment_5" value="5"> Để tạo điều kiện thuận
														lợi cho Quý khách, Hlink.vn chấp nhận nhiều hình thức
														thanh toán khác nhau để Quý khách có thể chọn lựa hình
														thức thanh toán nào tiện lợi nhất.
													</label>
													<hr>

													<div class="item_blockatm uk-clearfix" id="atm_bank_list">
														<div id="bank_3"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/17//80_24/bank_acb.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(3)"></div>
														<div id="bank_1"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/22/38//80_24/bank_agribank.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(1)"></div>
														<div id="bank_6"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/18//80_24/bank_bidv.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(6)"></div>
														<div id="bank_5"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/18//80_24/bank_donga.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(5)"></div>
														<div id="bank_12"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/21//80_24/bank_exim.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(12)"></div>
														<div id="bank_9"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/19//80_24/bank_maritimebank.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(9)"></div>
														<div id="bank_7"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/18//80_24/bank_mbbank.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(7)"></div>
														<div id="bank_10"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/20//80_24/bank_pgbank.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(10)"></div>
														<div id="bank_11"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/20//80_24/bank_sacombank.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(11)"></div>
														<div id="bank_4"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/17//80_24/bank_techcombank.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(4)"></div>
														<div id="bank_21"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/25//80_24/bank_vietabank.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(21)"></div>
														<div id="bank_13"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/21//80_24/b-logo-vcb.jpg) no-repeat center center"
															class="showbankimg" onclick="showBankInfo(13)"></div>
														<div id="bank_8"
															style="background: url(http://media.hlink.vn/u/bus/bank/2015/08/28/23/19//80_24/bank_vpbank.jpg) no-repeat center center"
													...
													<div id="atm_bank_info_list">
														<div id="bank_info_3" class="bank_info uk-hidden">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/17//80_24/bank_acb.jpg"
														...
														<div id="bank_info_1" class="bank_info uk-hidden">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/22/38//80_24/bank_agribank.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
																	...
																	<div>
																		<strong>Ngân hàng Nông nghiệp và Phát triển
																			Nông thôn Việt Nam (ARGRIBANK) - Chi nhánh Thăng Long</strong>
																	</div>
																	<div>
																		<span class="uk-text-danger">(Quý khách vui
																			lòng tự thanh toán chi phí CK)</span>
														...
														<div id="bank_info_6" class="bank_info uk-hidden">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/18//80_24/bank_bidv.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_5" class="bank_info uk-hidden">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/18//80_24/bank_donga.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_12" class="bank_info uk-hidden">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/21//80_24/bank_exim.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_9" class="uk-hidden bank_info">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/19//80_24/bank_maritimebank.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_7" class="uk-hidden bank_info">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/18//80_24/bank_mbbank.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_10" class="uk-hidden bank_info">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/20//80_24/bank_pgbank.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_11" class="uk-hidden bank_info">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/20//80_24/bank_sacombank.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_4" class="uk-hidden bank_info">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/17//80_24/bank_techcombank.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_21" class="uk-hidden bank_info">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/25//80_24/bank_vietabank.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_13" class="uk-hidden bank_info">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/21//80_24/b-logo-vcb.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
														...
														<div id="bank_info_8" class="uk-hidden bank_info">
															<div class="uk-grid uk-grid-collapse">
																<div class="uk-width-small-1-4 uk-text-center-small">
																	<img
																		src="http://media.hlink.vn/u/bus/bank/2015/08/28/23/19//80_24/bank_vpbank.jpg"
																		class="uk-margin-bottom">
																</div>
																<div class="uk-width-small-3-4">
																	<div>
											...
											<div data-wrapper="true"
												...
												<div class="uk-accordion-content">
													<label> <input type="radio" name="rdpayment"
														id="rdpayment_1" value="1"> Nhân viên giao nhận sẽ
														liên hệ với Quý khách để hẹn lịch giao hàng. Trong trường
														hợp Quý khách đi vắng, vui lòng uỷ thác cho người khác
														nhận hàng và thanh toán tiền thay.
													</label>
												</div>
											</div>
										</div>
									...
									<div>
										...
										<table class="uk-width-1-1" itemscope=""
											...
											<tbody>
												...
												<tr>
													<td>Loại ghế:</td>
													<td itemprop="description">Giường nằm 40 chỗ</td>
												</tr>
												<tr>
													<td>Giá vé:</td>
													<td itemprop="price"><strong>60</strong></td>
												</tr>
											</tbody>
										</table>
									</div>
...
<div class="" style="clear:both"></div>
	...
	$(document).ready(function(){
        var accordion = UIkit.accordion(UIkit.$('#list_pm'), {showfirst:false,collapse: true,duration:300});
		accordion.on({
			'toggle.uk.accordion': function (event, active, toggle, content) {
				$("input:radio").attr("checked", false);
				$('#pm_id').val(0);
				$('#pm_bank_id').val(0);
				$('.paylist').find('.active').removeClass('active');
				$('#pttt-tab-bank').find('.uk-active').removeClass('uk-active');
				showListAtm();
			}
		});
		...
		$("input:radio").bind('click',function(){
			...
			$('#pm_bank_'+pm_id).addClass('uk-active');
		});
    });
</script>
</body>
