	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Thông báo truy cập</li>
			</ol>
		</div>
		<!--/.row-->
		<div class="row" style="margin-top:10px;">
			<div class="col-md-12">
				<div class="panel panel-danger">
					<div class="panel-heading"><span class="glyphicon glyphicon-warning-sign"></span>Truy cập bị từ chối</div>
					<div class="panel-body">
						<p style="text-align: center">
							Bạn không đủ quyền truy cập vào trang này, vui lòng liên hệ quản trị viên hoặc đăng nhập bằng tài khoản khác tại <a href="<%=request.getContextPath()%>/admin/login"><b>đây</b></a>
						</p>
					</div>
				</div>
			</div>
