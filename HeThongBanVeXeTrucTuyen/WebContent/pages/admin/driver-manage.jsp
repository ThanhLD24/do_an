...
<title>Quản lý Tài xế, phụ xe</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="<%=request.getContextPath()%>/admin/driver"><i
						...
						<table data-toggle="table" data-show-refresh="false"
							...
							<tbody>
								<%
									...
									List<Employee> listEmployee = employeeDAO.getListEmployeeByDriver(Variables.DRIVER_JOB_ID, Variables.EXTRA_DRIVER_JOB_ID);
									Job job = null;
