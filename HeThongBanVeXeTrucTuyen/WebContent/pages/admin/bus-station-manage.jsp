	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="<%=request.getContextPath()%>/admin/driver"><i
					...
					&nbsp;&nbsp;&nbsp; Quản lý Tài xế </a></li>
			<li class="active"><a href="<%=request.getContextPath()%>/admin/bus-station"><i
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Quản lý Điểm dừng</li>
			</ol>
		</div>
		<!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="row">
						<div class="col-md-3">
					<button type="button" class="btn btn-primary" onclick="location.href = '<%=request.getContextPath()%>/admin/add-bus-station';">Thêm điểm dừng</button>
							</div>
						...
						<table data-toggle="table" data-show-refresh="false"
							...
							<thead>
								<tr>
									...
									<th data-sortable="true">Mã điểm dừng</th>
									<th data-sortable="true">Tỉnh/Thành phố</th>
									<th data-sortable="true">Tên điểm dừng</th>
							...
							<tbody>
								<%
									List<BusStation> listBusStation = ObjectManager.listObject(BusStation.class);
									Province pro = null;
									for (BusStation busStation : listBusStation) {
										pro = (Province) ObjectManager.getObjectById(busStation.getProvinceId(), Province.class);
								%>
								<tr>
									<td><%=busStation.getBusStationId()%></td>
									<td><%=pro.getProvinceName()%></td>
									<td><%=busStation.getBusStationName()%></td>
									<td><%=busStation.getBusStationNotes()%></td>
									...
									<td align="center"><p data-placement="top"
											...
											<button class="btn btn-primary btn-xs" data-title="Edit"
												data-toggle="modal"
												data-target="#edit<%=busStation.getBusStationId()%>"
												style="height: 22px">
										...
										<p data-placement="top" data-toggle="tooltip" title="Xóa"
											...
											<button class="btn btn-danger btn-xs" data-title="Xóa"
												data-toggle="modal"
												data-target="#delete<%=busStation.getBusStationId()%>"
												style="height: 22px">
								...
								<!-- popup edit -->
								<div class="modal fade" id="edit<%=busStation.getBusStationId()%>"
										...
										<div class="modal-content">
											<form id="formEditAccount"
												...
												<div class="modal-header">
													...
													<h4 class="modal-title custom_align" id="Heading">Sửa thông tin điểm dừng</h4>
												</div>
								...
								<div class="modal fade" id="delete<%=busStation.getBusStationId()%>"
									tabindex="-1" role="dialog" aria-labelledby="edit"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="alert alert-info">
													...
													nhận xóa điểm dừng ID: <b><%=busStation.getBusStationId()%></b>?
												</div>

											</div>
											<form id="formDeleteBusStation"
												action="<%=request.getContextPath()%>/AdminBusController?type=<%=Variables.DELETE_EMPLOYEE%>"
												method="post">
												<input class="form-control " type="hidden"
													value="<%=busStation.getBusStationId()%>" name="txtEmployeeId"
													id="txtEmployeeId">
												<div class="modal-footer ">
