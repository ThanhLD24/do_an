...
CREATE TABLE PERMIT(
	PERMIT_ID INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
	PERMIT_NAME VARCHAR(50)
);
CREATE TABLE ACCOUNT(
	...
	FOREIGN KEY (ACCOUNT_PERMIT) REFERENCES PERMIT(PERMIT_ID)
);
...
CREATE TABLE ORDER_TICKET(
	...
	ORDER_TICKET_OTHER				VARCHAR(200), /*luu lai id cua nhan vien thanh toan*/
	FOREIGN KEY (TICKET_ID) REFERENCES TICKET(TICKET_ID)
);
...
/* INSERT DATA TO TABLE PERMIT */
INSERT INTO PERMIT(PERMIT_NAME) VALUES('Quản lý hệ thống');
INSERT INTO PERMIT(PERMIT_NAME) VALUES('Quản lý vé');
...
INSERT INTO ACCOUNT(EMPLOYEE_ID, ACCOUNT_NAME, ACCOUNT_PASSWORD, ACCOUNT_PERMIT) VALUES(3,'hoangnd','e10adc3949ba59abbe56e057f20f883e',2);
